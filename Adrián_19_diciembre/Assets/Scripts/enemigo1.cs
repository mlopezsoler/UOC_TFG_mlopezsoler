...
public class enemigo1 : MonoBehaviour {
    ...
    void FixedUpdate()
    {
        ...
        GameObject enemigo1 = GameObject.FindGameObjectWithTag("enemigo1");

        // Recupero el target
        GameObject destino = GameObject.FindGameObjectWithTag("Target1");
        ...
        if (transform.position == target.position)
        {
            ...
            {
                enemigo1.GetComponent<SpriteRenderer>().flipX = true;
            }
            else
            {
                enemigo1.GetComponent<SpriteRenderer>().flipX = false;
            }
